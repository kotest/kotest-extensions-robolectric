...
publishing {
  ...
  publications {
    register("mavenJava", MavenPublication::class) {
      ...
      pom {
        name.set("kotest-extensions-robolectric")
        description.set("Kotest extension for Robolectric")
        url.set("http://www.github.com/kotest/kotest-extensions-robolectric")

        scm {
          connection.set("scm:git:http://www.github.com/kotest/kotest-extensions-robolectric")
